...
function transferencias(_a) {
    var workers = _a.workers, ano = _a.ano;
    return __awaiter(this, void 0, void 0, function () {
        var exercicio, entidade, url, browser, context, transferencias, retorno;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    transferencias = _b.sent();
                    return [4 /*yield*/, saveReceitas({ ano: ano, transferencias: transferencias })];
                case 4:
                    retorno = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 7:
                    _g.sent();
                    return [4 /*yield*/, (0, utils_1.goPage)(page, url, 'LnkTransf')];
                case 8:
                    _g.sent();
                    return [4 /*yield*/, (0, utils_1.removeDadosConsolidados)(page, url, 'LnkTransf')];
                case 9:
                    _g.sent();
                    return [4 /*yield*/, (0, utils_1.getColuns)(page, 'gridTransferencias')];
                case 10:
                    colunas = _g.sent();
                    todasLinhas = [];
                    _g.label = 11;
                ...
                case 12:
                    _g.sent();
                    return [4 /*yield*/, (0, utils_1.waitResponse)(page, 'TransferenciasPorEntidade.aspx')];
                case 13:
                    _g.sent();
                    return [4 /*yield*/, page.$$eval("#gridTransferencias_DXMainTable > tbody > tr.dxgvDataRow", function (elements) {
                            var linhas = [];
                ...
                case 14:
                    ...
                    return [4 /*yield*/, page.evaluate(function () {
                            return eval("aspxGVPagerOnClick('gridTransferencias','PBN');");
                        })];
                case 15:
                    _g.sent();
                    _g.label = 16;
...
function saveReceitas(_a) {
    var _b, transferencias_1, transferencias_1_1, _c, transferencias_2, transferencias_2_1;
    var _d, e_2, _e, _f, _g, e_3, _h, _j;
    var ano = _a.ano, transferencias = _a.transferencias;
    return __awaiter(this, void 0, void 0, function () {
        var result, transferencia, e_2_1, transferencia, e_3_1;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 1:
                    ...
                    _b = true, transferencias_1 = __asyncValues(transferencias);
                    _k.label = 2;
                case 2: return [4 /*yield*/, transferencias_1.next()];
                case 3:
                    if (!(transferencias_1_1 = _k.sent(), _d = transferencias_1_1.done, !_d)) return [3 /*break*/, 8];
                    _f = transferencias_1_1.value;
                    _b = false;
                    _k.label = 4;
                case 4:
                    _k.trys.push([4, , 6, 7]);
                    transferencia = _f;
                    return [4 /*yield*/, (0, utils_1.tratamento)(transferencia)];
                case 5:
                    _k.sent();
                    return [3 /*break*/, 7];
                case 6:
                ...
                case 10:
                    ...
                    if (!(!_b && !_d && (_e = transferencias_1.return))) return [3 /*break*/, 12];
                    return [4 /*yield*/, _e.call(transferencias_1)];
                case 11:
                    _k.sent();
                    _k.label = 12;
                ...
                case 15:
                    ...
                    _c = true, transferencias_2 = __asyncValues(transferencias);
                    _k.label = 16;
                case 16: return [4 /*yield*/, transferencias_2.next()];
                case 17:
                    if (!(transferencias_2_1 = _k.sent(), _g = transferencias_2_1.done, !_g)) return [3 /*break*/, 22];
                    _j = transferencias_2_1.value;
                    _c = false;
                    _k.label = 18;
                case 18:
                    _k.trys.push([18, , 20, 21]);
                    transferencia = _j;
                    return [4 /*yield*/, prisma.transferencia.upsert({
                            where: {
                            ...
                            update: __assign({}, transferencia),
                            create: __assign({ anoId: ano === null || ano === void 0 ? void 0 : ano.id }, transferencia),
                        })];
                case 19:
                    _k.sent();
                    result.push({ transferencia: transferencia });
                    return [3 /*break*/, 21];
                case 20:
                    _c = true;
                    return [7 /*endfinally*/];
                ...
                case 24:
                    ...
                    if (!(!_c && !_g && (_h = transferencias_2.return))) return [3 /*break*/, 26];
                    return [4 /*yield*/, _h.call(transferencias_2)];
                case 25:
                    _k.sent();
                    _k.label = 26;
