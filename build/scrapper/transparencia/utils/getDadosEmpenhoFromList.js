...
exports.getDadosEmpenhoFromList = void 0;
var _1 = require(".");
            ...
            switch (_c.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, page.waitForResponse(function (response) {
                            return response.url().includes('DadosEmpenho.aspx') &&
                                response.status() == 200;
                        })];
                case 6:
                    _c.sent();
                    _b = (_a = empenhos).push;
                    return [4 /*yield*/, (0, _1.getDadosEmpenho)(page)];
                case 7:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 8;
                case 8:
...
exports.getDadosEmpenhoFromList = getDadosEmpenhoFromList;
//# sourceMappingURL=getDadosEmpenhoFromList.js.map